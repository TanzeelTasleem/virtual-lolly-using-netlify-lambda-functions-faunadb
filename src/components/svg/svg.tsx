...
export const Lolly:React.FC<Props>=({fillLollyTop, fillLollyMiddle, fillLollyBottom})=>{
  return (
    <svg className="lollipop" width="160px" height="330px" viewBox="0 0 163 431" version="1.1" xmlns="http://www.w3.org/2000/svg">
    <defs>
